...
export class BaseController<T> implements IController<T> {
    ...
    protected authHandlers: Partial<Record<keyof IController<T>, IHandler>>;

    constructor(
        useCaseManager: IUseCaseManager<T>, 
        authHandlers?: Partial<Record<keyof IController<T>, IHandler>>
    ) {
